...
export default function RegisterPage() {
  ...
  return (
    <div className="mx-auto flex min-h-[70vh] max-w-md flex-col items-center justify-center px-4 py-12">
      ...
      <h1 className="font-sora text-2xl font-semibold text-[color:var(--sp-text)]">Create an account</h1>
      <p className="mt-1 text-sm text-[color:var(--sp-text-secondary)]">
        Already have one?{' '}
        <Link to="/login" className="font-medium text-[color:var(--sp-accent)] hover:underline">Sign in</Link>
      </p>
